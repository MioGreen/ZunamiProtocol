...
import "./IElasticVaultMigrator.sol";
...
abstract contract ElasticVault is ElasticERC20, IElasticVault {
    ...
    function migrateToOtherAsset(IERC20Metadata asset_, address priceOracle_, IElasticVaultMigrator migrator_) public onlyOwner {
        // reset daily limits
        dailyDepositTotal = 0;
